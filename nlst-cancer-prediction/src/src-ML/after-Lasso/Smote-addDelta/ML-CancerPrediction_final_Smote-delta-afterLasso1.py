...
# get the start time
st = time.time()
file_name = 'cancerprediction_DeltaT1_lasso_Smote-combat-TC_KT_man-notdropped-part1'
...
df_training_data = pd.read_csv(os.path.join(main_dir,'data/Training-Lasso-scaled-combat_TC_KT_man_notdropped-Delta1.csv'))
df_test_data = pd.read_csv(os.path.join(main_dir,'data/Test-Lasso-scaled-combat_TC_KT_man_notdropped-Delta1.csv'))
