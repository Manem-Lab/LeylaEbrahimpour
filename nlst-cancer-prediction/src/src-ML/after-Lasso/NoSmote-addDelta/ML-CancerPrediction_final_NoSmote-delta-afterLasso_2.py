...
file_name = 'cancerprediction_rads_DeltaT1_lasso_NoSmote_part2'
...
df_training_data = pd.read_csv(os.path.join(main_dir,'data/data_lasso/deltaT1/Training-Lasso-scaled-Delta1.csv'))

#df_training_data = pd.read_csv(os.path.join(main_dir,'data/Training-Lasso-scaled-BaseAddDelta.csv'))

df_test_data = pd.read_csv(os.path.join(main_dir,'data/data_lasso/deltaT1/Test-Lasso-scaled-Delta1.csv'))
