...
data = pd.read_excel(os.path.join(main_dir,'data/matched_clinical_T_1711-clinical-rads.xlsx'))
...
X_train_clinical_df.to_csv(os.path.join(main_dir,'data/T-train_data_os_st1_2_clinical.csv'), index=False, float_format='%.7f')
X_test_clinical_df.to_csv(os.path.join(main_dir,'data/T-test_data_os_st1_2_clinical.csv'), index=False, float_format='%.7f')
...
combined_df_train.to_csv(os.path.join(main_dir,'data/T-train_data_os_st1_2_rad.csv'), index=False, float_format='%.7f')
combined_df_test.to_csv(os.path.join(main_dir,'data/T-test_data_os_st1_2_rad.csv'), index=False, float_format='%.7f')