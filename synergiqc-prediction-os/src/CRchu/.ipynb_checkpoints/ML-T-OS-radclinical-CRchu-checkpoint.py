...
file_name = 'T-OS_st1_2_rad_clinical_test2'
#Load the data
...
df_training_data_clinical = pd.read_csv(os.path.join(main_dir,'data/T-train_data_os_st1_2_clinical.csv'))
df_test_data_clinical = pd.read_csv(os.path.join(main_dir,'data/T-test_data_os_st1_2_clinical.csv'))
