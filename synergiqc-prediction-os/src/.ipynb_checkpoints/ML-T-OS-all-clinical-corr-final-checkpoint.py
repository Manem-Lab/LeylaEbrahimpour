...
file_name = 'T-OS_st1_2_Ada_rad_clinical_corr_tex_all'
...
df_training_data = pd.read_csv(os.path.join(main_dir,'data/T-train_data_os_st1_2_rad_corr_tex.csv'))
df_test_data = pd.read_csv(os.path.join(main_dir,'data/T-test_data_os_st1_2_rad_corr_tex.csv'))

#load the clinical data for the same training and test dataset that have been created by dataset_feature_type.py code
df_training_data_clinical = pd.read_csv(os.path.join(main_dir,'data/T-train_data_os_st1_2_clinical_corr_tex.csv'))
df_test_data_clinical = pd.read_csv(os.path.join(main_dir,'data/T-test_data_os_st1_2_clinical_corr_tex.csv'))
